 ...
 * content of its items through an {@link com.wabbit.libraries.asynclist.ItemManager}.</p>
 *
 * <p>AsyncGridView behaves exactly like an ordinary
 * {@link android.widget.GridView GridView} when it has no {@link com.wabbit.libraries.asynclist.ItemManager}
 * set. Once an {@link com.wabbit.libraries.asynclist.ItemManager} is set, it will you use the associated
 * {@link com.wabbit.libraries.asynclist.ItemLoader} to asynchronously load the content of its items as the
 * the user scrolls the view.</p>
 *
 * <p>Use {@link #setItemManager(com.wabbit.libraries.asynclist.ItemManager)} to set an {@link com.wabbit.libraries.asynclist.ItemManager} on
...
public class AsyncGridView extends GridView implements AsyncAbsListView {
    ...
    /**
     * Sets an {@link com.wabbit.libraries.asynclist.ItemManager} on the {@link com.example.AsyncGridView}. Once this is
     * set, the {@link com.example.AsyncGridView} will use its associated {@link com.wabbit.libraries.asynclist.ItemLoader}
     * to asynchronously load the content its items in a background thread.
     *
     * @param itemManager - {@link com.wabbit.libraries.asynclist.ItemManager} to associate with the view.
     */
    @Override
