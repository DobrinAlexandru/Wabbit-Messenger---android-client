 ...
 * {@link android.widget.ListView ListView} when it has no {@link com.wabbit.libraries.asynclist.ItemManager}
 * set. Once an {@link com.wabbit.libraries.asynclist.ItemManager} is set, it will you use the associated
 * {@link com.wabbit.libraries.asynclist.ItemLoader} to asynchronously load the content of its items in a
...
public class AsyncListView extends ListView implements AsyncAbsListView {
    ...
    /**
     * Sets an {@link com.wabbit.libraries.asynclist.ItemManager} on the {@link com.example.AsyncListView}. Once this is
     * set, the {@link com.example.AsyncListView} will use its associated {@link com.wabbit.libraries.asynclist.ItemLoader}
