 ...
 * with its associated {@link com.wabbit.libraries.asynclist.ItemLoader}. Once an ItemManager
 * is set on an {@link AsyncAbsListView}, the {@link com.wabbit.libraries.asynclist.ItemLoader}
 * hooks will be called as needed to asynchronously load and
 * display items.</p>
 *
 * <p>ItemManager instances should be created using its
 * {@link com.example.ItemManager.Builder Builder} class. An example call:</p>
 *
 * <pre>
...
public final class ItemManager {
    ...
    private class SelectionTracker implements OnItemSelectedListener {
        @Override
    ...
    /**
    * Builder class for {@link com.example.ItemManager}.
    *
    * @author Lucas Rocha <lucasr@lucasr.org>
    */
    public final static class Builder {
        ...
        /**
         * @param itemLoader - Your {@link com.wabbit.libraries.asynclist.ItemLoader} subclass implementation.
         */
        ...
        /**
         * @return A new {@link com.example.ItemManager} created with the arguments
