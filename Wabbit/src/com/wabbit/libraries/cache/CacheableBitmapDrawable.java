...
public class CacheableBitmapDrawable extends BitmapDrawable {
    ...
    /**
     * @return true - if the bitmap is currently being displayed by a {@link com.wabbit.libraries.cache.CacheableImageView}.
     */
     ...
     * @see com.wabbit.libraries.cache.Constants#UNUSED_DRAWABLE_RECYCLE_DELAY_MS
     */
    ...
    /**
     * Runnable which run a {@link cache.CacheableBitmapDrawable#checkState(boolean) checkState(false)}
     * call.
     *
     * @author chrisbanes
     */
